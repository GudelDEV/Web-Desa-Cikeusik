...
// Query total data
$totalQuery = "SELECT COUNT(*) AS total FROM Saran_warga";
...
$query = "SELECT * FROM saran_warga ORDER BY tanggal_saran DESC LIMIT $limit OFFSET $offset";
...
$total_saran = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) AS total FROM saran_warga"))['total'];
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="Rsaran.php?id=<?php echo urlencode($id) ?>" class="nav-link active"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Saran Warga</p>
                                        <span class="badge badge-info right "
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Dengarkan Saran Dari Warga</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item active"><a href="#">Saran Warga</a></li>
            ...
            <section class="content">
                    ...
                    <section class="box">
                        <div class="info-box" style="width: 300px;">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Total Saran Dari Warga </span>
                                <span class="info-box-number">
                                    <?php  echo $total_saran ?>
                                </span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Daftar Saran Dari warga</h3>
                        ...
                        <table class="table">
                            ...
                            <tbody id="table-data">
                                ...
                                <tr>
                                    ...
                                    <td><?= date('d-m-Y H:i', strtotime($item['tanggal_saran'])) ?></td>
                                    <td>
                                    <td>
                                        <a href="#" class="btn btn-success btn-lihat"
                                            data-id="<?= $item['id_saran']; ?>" data-bs-toggle="modal"
                                            data-bs-target="#modalLaunch">Lihat</a>
                                        <a href="#" class="btn btn-secondary btn-feedback "
                                            data-id="<?= $item['id_saran']; ?>" data-bs-toggle="modal"
                                            data-bs-target="#modalLaunch">Feedback</a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="saranForm" method="POST" enctype="multipart/form-data">
                                            <!-- Nama Pengadu -->
                                            <div class="mb-3">
                                                <label for="nama" class="form-label">Nama Pemberi Saran</label>
                                            ...
                                            <section class="mb-3">
                                                ...
                                                <textarea class="form-control" id="saranDetail" rows="3" name="message"
                                                    disabled></textarea>
                                            </section>
