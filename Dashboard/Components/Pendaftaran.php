...
// Query total data
$totalQuery = "SELECT COUNT(*) AS total FROM pendaftaran";
...
$query = "SELECT * FROM pendaftaran ORDER BY tanggal_daftar DESC LIMIT $limit OFFSET $offset";
...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="Pendaftaran.php?id=<?php echo urlencode($id) ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Pendaftaran</p>
                                        <span class="badge badge-info right "
                                            style="margin-left: -100px !important; ">2</span>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item active"><a href="#">Pendafataran</a></li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-success btn-lihat"
                                            data-id="<?= $item['id_daftar']; ?>" data-bs-toggle="modal"
                        ...
                        <div class="modal fade" id="modalLaunch" tabindex="-1" aria-labelledby="modalLaunchLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body modal-Lihat">
                                        <!-- Koneten Disi Oleh Javascript -->
    ...
    <!-- My js -->
    <script src="../JS/proses_pendaftaran.js"></script>
